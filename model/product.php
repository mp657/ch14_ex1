...
class Product
{
    private $category   = 123;
    private $id         = 789;
    private $code       = 'PD-123';
    private $name       = 'product name';
    private $price      = 123.99;
    ...
    public function setCategory($value = 123)
    {
        $this->category = $value;
    }
    ...
    public function setID($value = 789)
    {
        $this->id = $value;
    }
    ...
    public function setCode($value = 'PD-123')
    {
        $this->code = $value;
    }
    ...
    public function setName($value = 'product name')
    {
        $this->name = $value;
    }
    ...
    public function setPrice($value= 123.99)
    {
        $this->price = $value;
    }
